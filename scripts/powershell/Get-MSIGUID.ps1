<#
.SYNOPSIS
    This script grabs the GUID from a MSI and outputs it into the terminal. This is useful for creating an uninstall command for a MSI in Intune.
#>


$path = "MSI PATH ON YOUR DEVICE"
